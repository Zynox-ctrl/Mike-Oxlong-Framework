...
parser = argparse.ArgumentParser(description="[!]Mike Oxlong brute force")
...
if args.login or args.password:
	...
	if os.path.exists(password_list):
		...
		sys.exit(1)
def banner():
	text1 = '''  __  __ _ _           ____       _                     __  __       _ _ 
 |  \/  (_) |         / __ \     | |                   |  \/  |     (_) |
 | \  / |_| | _____  | |  | |_  _| | ___  _ __   __ _  | \  / | __ _ _| |
 | |\/| | | |/ / _ \ | |  | \ \/ / |/ _ \| '_ \ / _` | | |\/| |/ _` | | |
 | |  | | |   <  __/ | |__| |>  <| | (_) | | | | (_| | | |  | | (_| | | |
 |_|  |_|_|_|\_\___|  \____//_/\_\_|\___/|_| |_|\__, | |_|  |_|\__,_|_|_|
                                                 __/ |                   
                                                |___/                    '''
...
def check_mail():
	...
	print(H+"""
		...
		7) By hand
		"""+E)
	ServerSmtp = input(W+'Mike Oxlong»Mail»ServerSmtp»'+E)
	if int(ServerSmtp) == 1:
		serv = 'smtp.gmail.com'
		port = 465
